              ...
              <div>
                ...
                <div className="bg-white rounded-xl shadow-sm p-4 mb-6 flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {videoEnabled && !isStillStreaming && videoPending.size > 0 && (
                      <span className="flex items-center gap-1.5 text-xs text-indigo-600">
                        <span className="w-3 h-3 border-2 border-indigo-300 border-t-indigo-600 rounded-full animate-spin" />
                        Generating {videoPending.size} video{videoPending.size !== 1 ? 's' : ''}…
                      </span>
                    )}
                      ...
                      >
                        ...
                        {videoEnabled && (
                          moduleVideos[mod.module_id] ? (
                            ...
                            <div className="mt-4 flex items-center justify-between gap-3 bg-indigo-50 border border-indigo-100 rounded-xl px-4 py-3">
                              <div className="flex items-center gap-2">
                                <span className="w-4 h-4 border-2 border-indigo-300 border-t-indigo-600 rounded-full animate-spin flex-shrink-0" />
                                <span className="text-xs font-medium text-indigo-700">Generating video intro…</span>
                              </div>
                              <span className="text-xs text-indigo-400">~50 s per module</span>
                            </div>
                          ) : null
                        )}
                      </div>
